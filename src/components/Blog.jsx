...
const Blog = () => {
    ...
    return (
     ...
     data-aos-offset="300"
     data-aos-easing="ease-in-sine" className="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-b md:pl md:pr relative">
  <div className="bg-cover bg-center text-center overflow-hidden" style={{minHeight: 500, backgroundImage: 'url("https://api.time.com/wp-content/uploads/2020/07/never-trumpers-2020-election-01.jpg?quality=85&w=1201&h=676&crop=1")'}} title="Woman holding a mug">
  </div>
